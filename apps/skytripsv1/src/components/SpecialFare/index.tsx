  ...
  useEffect(() => {
    ...
    const fetchDeals = async () => {
      try {
        ...
        const response = await axiosInstance.get('/deals?limit=250');
    ...
    <>
      {hasActiveDeals && (
        <div className="w-full py-6 rounded-sm">
          <div className=" ">
            <h2 className="h3 text-background-on text-left mb-6">
              Holiday Deals
            </h2>
                  ...
                  >
                    ...
                    <div className="relative w-full h-[200px]">
                      <img
                        ...
                        alt={`${
                          fare.originalDeal.media?.fileAltText
                            ? fare.originalDeal.media.fileAltText
                            : `${fare.origin} to ${fare.destination} flight deal`
                        }`}
                        loading="lazy"
                        width="100%"
                        height="200"
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-left mb-1">
                        ...
                        <div className="flex items-center">
                          {/* {fare.destinationIcon && (
                        <div className="w-6 h-6 rounded-full overflow-hidden mr-2">
                          <Image
                            src={fare.destinationIcon}
