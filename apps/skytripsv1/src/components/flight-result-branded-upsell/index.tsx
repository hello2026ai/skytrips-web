...
// import { decodeData } from '../../utils/urlEncoding';
// import { format } from 'date-fns';
// import { RefreshCw, ChevronDown, ChevronUp, ChevronRight } from 'lucide-react';
// import { Tabs, TabsList, TabsTrigger } from '../../components/ui/tabs';
// import { Button } from '../../components/ui/button';
// import FareSelectionDrawer from '../../components/flights/FareSelectionDrawer';
...
//     ) {
//       console.log(
//         `Currency mismatch: fare domainRegionCurrencyCode ${fare.domainRegionCurrencyCode} vs selected currency ${selectedCurrency}`
//       );
//       return false;
//     }
...
//     if (
//       fare.origin?.iataCode !== originCode ||
//       fare.destination?.iataCode !== destinationCode
//     )
//       return false;
...
//       // Add tax back to get the final display total
//       return discountedBasePrice + taxAmount;
...
//     // Apply fare pricing to all flights that show Best Value tag
...
//       }
//     }
//     return { price: parseFloat(flight.price.grandTotal) };
//   };
...
//                             index
//                           );
//                           console.log('showBestValue', showBestValue);
//                           return (
//                             <div
//                               key={`${flight.id}-${index}-${activeTab}`}
//                               className="flex flex-col"
//                             >
//                               <div className="bg-container rounded-lg border border-[#EEEEEE] overflow-hidden duration-200 relative">
//                                 {/* Best Value Tag */}
//                                 {/* {showBestValue && (
...
//                                                   Total:
//                                                 </span>
//                                                 <span className="title-t3 text-primary">
//                                                   {flight.price.currency}{' '}
//                                                   {Math.floor(price)}
//                                                 </span>
//                                                 <span className="label-l3 text-neutral-dark line-through">
...
//                                         <Button
//                                           variant="outline"
//                                           className="flex-1  bg-primary text-primary-on hover:bg-[#5143d9]"
//                                           onClick={() => {
//                                             const cardId = `main-${flight.id}-${index}`;
//                                             setSelectedCardId(
...
//                                         </Button>
//                                         {/* <Button
//                                           className="flex-1 hover:bg-[#5143d9] title-t4 text-primary-on bg-primary"
//                                           onClick={() => {
...
//                                                   customLabel:
//                                                     bestValueFare?.customLabel,
//                                                   fareDeductionValueType:
//                                                     bestValueFare?.fareDeductionValueType,
//                                                   deductionValue:
//                                                     bestValueFare?.deductionValue,
//                                                   farePerPassengers:
//                                                     bestValueFare?.farePerPassengers,
//                                                   originalPrice:
//                                                     priceData.originalPrice,
//                                                   discountedPrice:
//                                                     priceData.price,
//                                                   flightBasePrice: parseFloat(
//                                                     flight.price.base
//                                                   ),
//                                                   flightGrandTotal: parseFloat(
...
//                                               );
//                                               console.log(
//                                                 '🏆 Best Value booking stored in localStorage:',
//                                                 bestValueInfo
//                                               );
//                                             } else {
...
//                                                       className="flex-1 border-primary hover:bg-primary/10"
//                                                       onClick={() => {
//                                                         const cardId = `offer-${flight.id}-${index}-${offerIdx}`;
//                                                         setSelectedCardId(
//                                                           selectedCardId ===
//                                                             cardId
//                                                             ? null
