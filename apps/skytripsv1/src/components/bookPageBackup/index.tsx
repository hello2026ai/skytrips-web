...
//       // Log the booking reference being used
//       console.log('Using booking reference:', bookingReference);
//       // toast.loading('Processing payment...', {
//       //   id: 'payment-process'
//       // });

//       // Collect browser info first before API calls
//       let browserInfoValue = '';
//       let ipAddressValue = '';
//       let timeZoneValue = '';

//       // Collect browser info
//       if (typeof window !== 'undefined') {
//         browserInfoValue = navigator.userAgent;
//         timeZoneValue = Intl.DateTimeFormat().resolvedOptions().timeZone;
//         setBrowserInfo(browserInfoValue);
//         setTimeZone(timeZoneValue);

//         // Get IP address (simplified - in production would use a service)
//         try {
//           const ipResponse = await fetch('https://api.ipify.org?format=json');
//           const ipData = await ipResponse.json();
//           ipAddressValue = ipData.ip;
//           setIpAddress(ipAddressValue);
//         } catch (err) {
//           console.error('Failed to get IP address:', err);
//           ipAddressValue = '127.0.0.1'; // Fallback
//           setIpAddress(ipAddressValue);
//         }
//       }
...
//       console.log('Sending create token request:', createTokenPayload);

//       // Create token
//       const response = await axiosInstance.post(
//         '/flight-payment/token',
...
//       ) {
//         const redirectHtml = response?.data?.authentication?.redirectHtml;

//         // toast.info('3D Secure authentication required. Please complete the verification.', {
//         //   id: 'payment-process'
//         // });

//         // Show 3D Secure iframe modal first
//         setIsOpenThreedsSecureModal(true);

//         // Small delay to ensure modal is rendered
//         setTimeout(() => {
//           // Write to the iframe in the modal directly
...
//             if (iframeDoc) {
//               iframeDoc.open();
//               iframeDoc.write(redirectHtml);
//               iframeDoc.close();

//               // Attempt to add message listener to the iframe content window
//               try {
...
//                             console.log(
//                               '3D Secure authentication successful via direct iframe message'
//                             );
//                             toast.success(
...
//                               finalizePayment(token, bookingReference);
//                             }
//                           }
//                         } catch (error) {
//                           console.error(
...
//               } catch (e) {
//                 console.log(
//                   'Could not add message listener directly to iframe:',
//                   e
//                 );
//               }
//             }
...
//           // Update token with browser info
//           updateCardToken(
//             response?.data?.id,
//             browserInfoValue,
//             ipAddressValue,
...
//         // toast.info('Payment token created. Finalizing payment...', {
//         //   id: 'payment-process'
//         // });
//         await finalizePayment(response?.data?.id, bookingReference);
//       }
//     } catch (error) {
//       console.log('Error creating payment token:', error);
