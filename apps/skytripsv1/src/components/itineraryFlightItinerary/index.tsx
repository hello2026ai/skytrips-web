...
const itineraryFlightItinerary: React.FC<FlightItineraryProps> = ({
  itineraries,
  formatDuration,
  getTransitTime,
  flight,
  ...
  const calculateTransitTime = (
    ...
    try {
      // Calculate time difference between current departure and previous arrival
                          ...
                          <span className="label-l3 text-neutral-dark inline-flex items-center ">
                            {(() => {
                              ...
                              if (
                                ...
                                if (
                                  'weight' in baggageInfo.includedCabinBags &&
                                  ...
                                  const weight =
                                    baggageInfo.includedCabinBags.weight;
                                  const weightUnit =
                                    baggageInfo.includedCabinBags.weightUnit ||
                                    'KG';
                                  return `Cabin Baggage: ${weight} ${weightUnit}`;
                                }
                                // Otherwise use quantity if available
                                else if (
                                  'quantity' in baggageInfo.includedCabinBags &&
                          ...
                          <span className="label-l3 text-neutral-dark inline-flex items-center">
                            {(() => {
                              ...
                              if (baggageInfo?.includedCheckedBags) {
                                ...
                                if (
                                  'weight' in baggageInfo.includedCheckedBags &&
                                ...
                                // If quantity is specified, display as 23+23+... KG
                                  ...
                                  'quantity' in
                                    baggageInfo.includedCheckedBags &&
                                  baggageInfo.includedCheckedBags.quantity !==
                                    undefined
                                ) {
                                  const quantity =
                                    baggageInfo.includedCheckedBags.quantity;
                                  if (quantity === 0) {
                                    ...
                                    return `Checked Baggage: ${Array(quantity)
                                      .fill('23')
                                      .join('+')} KG`;
                                  }
                                }
...
export default itineraryFlightItinerary;
