...
import NewHomepageSpecialfare from '../../components/NewHomepageSpecialfare';
...
export default function HomePage({ initialSettings }: HomeProps) {
  ...
  const defaultMetaTitle =
    generalSettings?.siteTitle && generalSettings.siteTitle.trim() !== ''
      ...
      : 'SkyTrips | Book Cheap Flights to Nepal';
    ...
    <>
      ...
      <div className=" flex flex-col">
        ...
        <main className="container flex-1">
          ...
          <section className="mt-3 mb-7 "></section>
