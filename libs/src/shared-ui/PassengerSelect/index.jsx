...
const PassengerSelect = ({
  ...
  return (
    <div className="select-container">
      <div className=" dropdown bg-light p-2 rounded-2 ">
        <div
          className="nav-link dropdown-toggle d-flex justify-content-between passenger-div"
          id="selectPassengers"
        ...
        >
          <li className="d-flex align-items-center justify-content-between mb-2">
            ...
            <div className=" d-flex align-items-center">
              ...
              >
                <i
                  className="fa fa-minus text-white p-2"
                  aria-hidden="true"
                ></i>
              </button>
              <span className="mx-2 select-container-count">
          ...
          <li className="d-flex align-items-center justify-content-between mb-2">
            <p className="mb-0 select-container-text">Children (2y - 11y)</p>
            <div className="d-flex align-items-center">
              <button
                className="nav-link rounded-start rounded-0 mb-0 btn btn-primary"
                type="button"
          ...
          <li className="d-flex align-items-center justify-content-between mb-2">
            <p className="mb-0 select-container-text">Infants (23 months)</p>
            <div className="d-flex align-items-center">
              <button
                className="nav-link rounded-start rounded-0 mb-0 btn btn-primary"
                type="button"
